...
* "LinkParser":http://deveiate.org/projects/Ruby-LinkParser (>= 1.0.5)
...
adding the appropriate symbol to the Linguistics::DEFAULT_LANGUAGES array.
...
'lib/linguistics/pt.rb' which contains the following:
	...
	module Linguistics
	  module PT
	    Linguistics::DEFAULT_LANGUAGES << :pt
