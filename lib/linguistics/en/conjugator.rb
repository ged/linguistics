...
module Linguistics::EN::Conjugator
  ...
  def past
    conjugate(self.obj.to_s, :past)
  end
  
  def past_participle
    conjugate(self.obj.to_s, :past_participle)
  end
  
  def present
    conjugate(self.obj.to_s, :present)
  end
  
  def present_participle
    conjugate(self.obj.to_s, :present_participle)
  end
  ...
  #  
  #
  def conjugate (infinitive, tense, person = nil)
